...
class HighlightEffect : public GPUEffectBase {
public:
    HighlightEffect() = default;
    ~HighlightEffect() { Shutdown(); }
    ...
    GPUEffectType GetType() const override { return GPUEffectType::Highlight; }
